# Please set up your environment before running the program via [this tutorial](info/Tutorial.md) and read the [update logs file](info/UpdateLogs.md) for the latest updates.
